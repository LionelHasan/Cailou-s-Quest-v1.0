...
CAILOU_VEL_X = 5
CAILOU_VEL_Y = 5
QUESTION_FONT =  pygame.font.SysFont("times new roman", 35)
...
class GameState():
    ...
    def multiple_choice(self):
        ...
        pygame.draw.rect(WIN, color3, d)
        question_text = QUESTION_FONT.render('Which of the statements below will properly print the addition of 7 and 12 and multiply that sum with 4?', 1,BLACK)
        a_text = MC_FONT.render('a.) print(7+12*4)', 1,BLACK)
        b_text = MC_FONT.render('b.) print((7+12)*4)', 1,BLACK)
        c_text = MC_FONT.render('c.) print(‘7’ + ‘12’ * ‘4’)', 1,BLACK)
        d_text = MC_FONT.render('d.) print(‘(7+12)*4’)', 1,BLACK)
    ...
    def password(self):
        ...
        def draw_password():
            ...
            password_text = MC_FONT.render('Password: yEy83K', 1, BLACK)
