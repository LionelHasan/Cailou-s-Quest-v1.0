...
class GameState():
    ...
    def multiple_choice(self):
        ...
        pygame.draw.rect(WIN, color3, d)
        question_text = QUESTION_FONT.render('Which of the following statements is true?', 1,BLACK)
        a_text = MC_FONT.render('a.) Mathematical operations can be conducted using numbers in string form', 1,BLACK)
        b_text = MC_FONT.render('b.) When printing variables, the variable must be enclosed in quotations/apostrophes', 1,BLACK)
        c_text = MC_FONT.render('c.) When printing variables, the variable must be enclosed in print statement brackets', 1,BLACK)
        d_text = MC_FONT.render('d.) Multiplication is denoted by ‘x’', 1,BLACK)
    ...
    def password(self):
        ...
        def draw_password():
            ...
            password_text = MC_FONT.render('Password: u75Fu6', 1, BLACK)
