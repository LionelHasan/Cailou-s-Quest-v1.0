...
pygame.display.set_caption('Topic 1 Multiple Choice 1')
...
class GameState():
    ...
    def multiple_choice(self):
        ...
        a_text = MC_FONT.render('a.) print(Dogs are better than cats!)', 1,BLACK)
        b_text = MC_FONT.render('b.) print(“Dogs are better than cats!")', 1,BLACK)
        c_text = MC_FONT.render('c.) print(“Dogs are better than cats!”)', 1,BLACK)
        d_text = MC_FONT.render('d.) print(‘dogs are better than cats!’)', 1,BLACK)
    ...
    def password(self):
        ...
        def draw_password():
            ...
            password_text = MC_FONT.render('Password: RbgF8W', 1, BLACK)
