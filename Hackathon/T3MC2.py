...
pygame.display.set_caption('Topic 3 - Multiple Choice 2')
...
class GameState():
    ...
    def multiple_choice(self):
        ...
        pygame.draw.rect(WIN, color3, d)
        question_text = QUESTION_FONT.render('Which conditional statement should trigger for the code written below:', 1,BLACK)
        a_text = MC_FONT.render('a.) If (first statement)', 1,BLACK)
        b_text = MC_FONT.render('b.) elif (second statement)', 1,BLACK)
        c_text = MC_FONT.render('c.) else (third statement)', 1,BLACK)
        d_text = MC_FONT.render('d.) None of the statements', 1,BLACK)
    ...
    def password(self):
        ...
        def draw_password():
            ...
            password_text = MC_FONT.render('Password: 4rH4Yf', 1, BLACK)
